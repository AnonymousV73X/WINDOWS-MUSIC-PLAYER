...
function renderHome() {
  ...
  if (customQueuesList) {
    if (!state.customQueues || state.customQueues.length === 0) {
      customQueuesList.innerHTML = `<div class="section-muted" style="padding:px 10px;">No custom queues saved yet. Click "Custom Queue" to create your first custom queue!</div>`;
    } else {
