...
class SquigglyProgress {
  constructor(canvas, opts = {}) {
    ...
    this.thumbWidth = opts.thumbWidth ?? 5.6;
    this.thumbHeight = opts.thumbHeight ?? 5.6;
    this.thumbRadius = opts.thumbRadius ?? 2;
  ...
  _drawThumb(ctx, x, cy, r) {
    const w = this.thumbWidth, h = this.thumbHeight, rad = this.thumbRadius;
    ctx.beginPath();
  ...
  renderSectionSurface(`
    <div class="help-layout">
      ...
      <div class="help-footer" style="text-align:center;padding:24px 0 12px;color:var(--text-muted);font-size:12px;">
        NovaTune v1.1.2 &bull; Made by SIR ALEX for music lovers
      </div>
    </div>
  `);
